  ...
  <Caixa>
    <Box>
        ...
        <Input  keyboardType="numeric" name="phone" icon="smartphone" placeholder="N° de telefone" />
         <Button  onPress={( ) => { navigation.navigate('LojiDashboard')}}>Entrar</Button>
        
   </Box>
      
  </Caixa>
        <CreateAccount  onPress={( ) => navigation.navigate('LojiInformation')}>
